  ...
  .then((users) => {
    ...
    return Shop
      .create([{
        ...
        bio: 'Oxfam is an international confederation of charitable organizations focused on the alleviation of global poverty.',
        icon: 'https://pbs.twimg.com/profile_images/875688263721385984/Fepaw00Z.jpg',
        ...
        bio: 'Cancer Research UK is a cancer research and awareness charity in the United Kingdom.',
      ...
      },
      {
        ...
        bio: 'Shelter is a registered charity that campaigns to end homelessness and bad housing in England and Scotland.',
        icon: 'http://media.shelter.org.uk/__data/assets/image/0003/355278/shelter-white-large.png',
        ...
        bio: 'SCT part of interfaith charity shop at Selfridges by Artangel and Miranda July',
        ...
        bio: 'We are the national charity for homeless people. We know that homelessness is not inevitable. We know that together we can end it.',
        ...
        comments: [
          {
            content: 'Can hardly tell it is a charity shop! Amazing things on sale.',
            createdBy: users[1]
          }
        ]
      }]);
